...
potholes_data = [
  ...
  { id: 47, address: "35 Essenwood Road, Musgrave, Durban, South Africa", size: "Medium", description: "Several medium-sized potholes close to a pedestrian crossing, posing a risk to both vehicles and pedestrians.", status: "Done", user_id: 20, latitude: -29.847986, longitude: 30.997632, photo: "https://lh3.googleusercontent.com/KwVGLnl9FRu7HmTlope4YtgDTqwEJ_H6HvBR7pp37x4hj5C1aDXR9ODoJ7gj25nmeOFCTQm8i7uqLg2xMxB23Bo2Q1ZKlpQgo9U=s750" },
  { id: 48, address: "56 Northway, Durban North, Durban, South Africa", size: "Large", description: "Deep pothole at the entrance of a shopping center, leading to multiple vehicle damages.", status: "In progress", user_id: 20, latitude: -29.783969, longitude: 31.036516, photo: "https://image-prod.iol.co.za/16x9/800/The-South-African-National-Roads-Agency-Limited-Sanral-has-disbursed-over-R15-million-to-motorists-for-vehicle-damage-caused-by-pothole-riddled-national-roads-File-Picture-Boxer-Ngwenya-Independent-Newspapers?source=https://iol-prod.appspot.com/image/ad0c4e17b32e22d0a54aa291eb1cac4991837a55/2000&operation=CROP&offset=0x103&resize=2000x1125" },
